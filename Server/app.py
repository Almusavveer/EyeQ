...
def extract_questions_from_pdf(pdf_file_stream):
    """
    Extracts student information from a PDF file stream.
    Expects student data in formats like:
    - Roll No: 2021CS001, Name: John Doe, Email: john@example.com
    - Student ID: 2021CS001 | Student Name: John Doe | Department: Computer Science
    - Or tabular format with headers
    """
    all_text = ""
    try:
        # Reset file pointer to beginning
    ...
    for line in lines:
        ...
        # Pattern 2: Separated by | or tabs
    ...
    print(f"Extracted {len(students)} students from PDF")
    return students
    """
